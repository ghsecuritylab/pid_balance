...
#define MBED_CONF_TARGET_CTRL01_ENABLE                    0                                                                                                // set by target:NUMAKER_PFM_M487
#define MBED_CONF_TARGET_GPIO_IRQ_DEBOUNCE_CLOCK_SOURCE   GPIO_DBCTL_DBCLKSRC_LIRC                                                                         // set by target:NUMAKER_PFM_M487
#define MBED_CONF_TARGET_GPIO_IRQ_DEBOUNCE_ENABLE         0                                                                                                // set by target:NUMAKER_PFM_M487
#define MBED_CONF_TARGET_GPIO_IRQ_DEBOUNCE_ENABLE_LIST    NC                                                                                               // set by target:NUMAKER_PFM_M487
#define MBED_CONF_TARGET_GPIO_IRQ_DEBOUNCE_SAMPLE_RATE    GPIO_DBCTL_DBCLKSEL_16                                                                           // set by target:NUMAKER_PFM_M487
#define MBED_CONF_TARGET_USB_DEVICE_HSUSBD                1                                                                                                // set by target:NUMAKER_PFM_M487
