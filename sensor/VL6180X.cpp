...
*/
/**************************************************************************/
MHEtLive_VL6180X::MHEtLive_VL6180X(void) {
}
...
*/
/**************************************************************************/
boolean MHEtLive_VL6180X::begin(TwoWire *theWire) {
...
void MHEtLive_VL6180X::loadSettings(void) {
    // load settings!
...
uint8_t MHEtLive_VL6180X::readRange(void) {
...
uint8_t MHEtLive_VL6180X::readRangeStatus(void) {
...
float MHEtLive_VL6180X::readLux(uint8_t gain) {
  uint8_t reg;
...
uint8_t MHEtLive_VL6180X::read8(uint16_t address)
{
  uint8_t data;
...
uint16_t MHEtLive_VL6180X::read16(uint16_t address)
{
  uint16_t data;
...
// write 1 byte
void MHEtLive_VL6180X::write8(uint16_t address, uint8_t data)
{
  Wire.beginTransmission(_i2caddr);
  Wire.write(address>>8);
  Wire.write(address);
...
// write 2 bytes
void MHEtLive_VL6180X::write16(uint16_t address, uint16_t data)
{
  Wire.beginTransmission(_i2caddr);
  Wire.write(address>>8);
  Wire.write(address);
